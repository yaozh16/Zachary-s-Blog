...
# 其他
<h3 id="h3-u8BC6u522Bu8F93u5165u4E8Bu4EF6"><a name="识别输入事件" class="reference-link"></a><span class="header-link octicon octicon-link"></span>识别输入事件</h3>
<table>
<thead>
<tr>
<th>事件名</th>
...
<h3 id="h3-asr_start-"><a name="ASR_START 输入事件参数" class="reference-link"></a><span class="header-link octicon octicon-link"></span>ASR_START 输入事件参数</h3><table>
<thead>
<tr>
<th>事件参数</th>
<th>类型/值</th>
...
<h3 id="h3-asr_kws_load_engine-"><a name="ASR_KWS_LOAD_ENGINE 输入事件参数" class="reference-link"></a><span class="header-link octicon octicon-link"></span>ASR_KWS_LOAD_ENGINE 输入事件参数</h3><table>
<thead>
<tr>
<th>事件参数</th>
<th>类型</th>
...
<h3 id="h3-pid-"><a name="PID 参数" class="reference-link"></a><span class="header-link octicon octicon-link"></span>PID 参数</h3><p>在线参数， 请根据语言， 输入法或者搜索模型及是否需要在线语义，来选择PID。</p>
<ul>
...
<h2 id="h2-u8F93u51FAu53C2u6570"><a name="输出参数" class="reference-link"></a><span class="header-link octicon octicon-link"></span>输出参数</h2><p>语音回调事件统一由   public void onEvent(String name, String params, byte[] data, int offset, int length) 该方法回调<br>其中name是回调事件， params是回调参数。（data，offset，length）缓存临时数据，三者一起，生效部分为 data[offset] 开始，长度为length。</p>
<table>
<thead>
<tr>
<th>事件名（name）</th>
